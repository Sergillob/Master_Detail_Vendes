...
sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sl.controller.Master", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("sl.view.ViewSettingsDialog", this);
		...
		/**
		 *@memberOf sl.controller.Master
		 */
		onAdd: function() {
			//This code was generated by the layout editor.
			//Volem navegar a la nostra nova Add.view!!!
			this.getRouter().navTo("add"); //On aquí "add" és la Route que hem de definir al manifest.json!!
		}
	});
});