sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Vbeln").length, 1, "The sorting by Vbeln returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Vbeln and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "Netwr");

		this.oGroupSortState.sort("Vbeln");
